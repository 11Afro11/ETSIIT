...
//
// Fichero: Matriz2D_2_ConstructorCopia.h
//
/***************************************************************************/

	#ifndef MATRIZ_2D_2_CONSTRUCTOR_COPIA
	#define MATRIZ_2D_2_CONSTRUCTOR_COPIA
	...
	public:
		...
		Matriz2D_2 & operator=(const Matriz2D_2 &otra_matriz);

		Matriz2D_2 & operator=(const TipoBase value);
