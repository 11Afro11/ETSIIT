...
// EJERCICIO 2
//
// Escribir un programa que reciba el nombre de dos ficheros. El programa copiará, en el mismo
//orden, los números que contiene el fichero de entrada en el fichero de salida.
//
