...
/***************************************************************************/
	...
	Matriz2D_2 :: Matriz2D_2 (istream & fi){
	...
	//Metodo que cuenta las columnas
	int Matriz2D_2::CuentaColumnas(istream & fi){
		string linea;
		bool vacio;
		int n;
		int cont = 0;
	...
	//Metodo que aniade una fila(recibe un puntero a datos de tipo tipobase)
	void Matriz2D_2::AniadeFila(const TipoBase *numeros){
